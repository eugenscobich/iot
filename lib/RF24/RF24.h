...
public:
     ...
     *
     * @param _hspi Address of HAL SPI_HandleTypeDef
     * @param _nrf_ce_GPIOx GPIO_TypeDef of Chip Enable pin
     * @param _nrf_ce_GPIO_Pin Chip Enable pin number
     * @param _nrf_csn_GPIOx GPIO_TypeDef of Chip Select (often labeled CSN) pin
     * @param _nrf_csn_GPIO_Pin Chip Select (often labeled CSN) pin number
     * @param _spi_speed The SPI speed in Hz ie: 1000000 == 1Mhz
     */
    RF24(SPI_HandleTypeDef* _hspi, GPIO_TypeDef* _nrf_ce_GPIOx, uint16_t _nrf_ce_GPIO_Pin, GPIO_TypeDef* _nrf_csn_GPIOx, uint16_t _nrf_csn_GPIO_Pin, uint32_t _spi_speed = RF24_SPI_SPEED);

    /**
     * A constructor for initializing the radio's hardware dynamically
     * @warning You MUST use begin(_nrf_ce_GPIOx, _nrf_ce_GPIO_Pin, _nrf_csn_GPIOx, _nrf_csn_GPIO_Pin) or begin(_hspi, _nrf_ce_GPIOx, _nrf_ce_GPIO_Pin, _nrf_csn_GPIOx, _nrf_csn_GPIO_Pin) to pass both the
     ...
     * and CSN pin to use.
     * @param _hspi HAL SPI_HandleTypeDef
     * @param _nrf_ce_GPIOx GPIO_TypeDef of Chip Enable pin
     * @param _nrf_ce_GPIO_Pin Chip Enable pin number
     * @param _nrf_csn_GPIOx GPIO_TypeDef of Chip Select (often labeled CSN) pin
     * @param _nrf_csn_GPIO_Pin Chip Select (often labeled CSN) pin number
     ...
     */
    bool begin(SPI_HandleTypeDef* _hspi, GPIO_TypeDef* _nrf_ce_GPIOx, uint16_t _nrf_ce_GPIO_Pin, GPIO_TypeDef* _nrf_csn_GPIOx, uint16_t _nrf_csn_GPIO_Pin);
     ...
     * @return same result as begin()
     */
    bool begin(GPIO_TypeDef* _nrf_ce_GPIOx, uint16_t _nrf_ce_GPIO_Pin, GPIO_TypeDef* _nrf_csn_GPIOx, uint16_t _nrf_csn_GPIO_Pin);
